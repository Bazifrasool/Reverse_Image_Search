...
class ReverseImageSearch:
    def __init__(self):
        self.model=keras.models.load_model("./model_files/resnet50.h5")
    ...
    def query_class(self,n_results,query_path,gui=False):
...
def feature_embeddings_generate(path,batch_sz):
...
if __name__ == "__main__":
    img=ReverseImageSearch()
    img.query_class(3,"./query.jpg",True)
